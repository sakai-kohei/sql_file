...
CREATE TABLE IF NOT EXISTS allocation_budjet_master (record_year CHAR(4), department_cc_code CHAR(6),  cc_code CHAR(6), subjects VARCHAR(5), record_month VARCHAR(3), amount INT);